...
const navLinks = [
  ...
  {
    label: 'Resume',
    href: 'https://docs.google.com/document/d/1baFxz880bwpHy8L0S91R3N1W0Ou0C3GJbxlDbjYw9Yo/edit?tab=t.0',
    external: true,
  },
]
        ...
        <div className="max-w-[1400px] mx-auto section-padding flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-8">
            {navLinks.map((link) => (
              <a
                ...
                {...('external' in link && link.external
                  ...
                  : {})}
                className="relative text-sm text-muted hover:text-text transition-colors duration-200 group"
              >
                {link.label}
            ...
            <a
              ...
              className="text-sm font-medium text-text border border-border px-4 py-1.5 rounded-lg hover:border-accent/60 hover:text-accent transition-all duration-200"
            >
              GitHub
            </a>
          </nav>
      ...
      <AnimatePresence>
        {menuOpen && (
          <motion.div
            ...
            className="fixed inset-0 z-40 bg-background/97 backdrop-blur-xl flex flex-col pt-24 section-padding"
          >
